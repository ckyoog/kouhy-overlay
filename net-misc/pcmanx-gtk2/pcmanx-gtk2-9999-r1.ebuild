# TODO
# This ebuild is not working now.
# The original SVN repo is unavailable (see pcmanx-gtk2-9999.ebuild for details)
# I find it on Github, but I don't know what it has changed for so many years.
# Some of old patches are all not be able to work for the Github version.
# I will fix it later. (There are some old git sources in $DISTDIR/git-src/, one
# of which is pcmanx. Check it out)
