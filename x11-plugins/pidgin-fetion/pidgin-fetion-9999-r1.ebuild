# TODO
# The Github URL is still available. It is an ancient package.
# Fortunately, the author didn't delete it from his Github repo.
# But the old ebuild doesn't work any more, e.g., function git_src_unpack is gone.
# I will fix it later, and see if this package is still able to be compiled.
