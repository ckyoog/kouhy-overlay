...
# $Header: /var/cvsroot/gentoo-x86/sys-kernel/tuxonice-sources/tuxonice-sources-3.8.3.ebuild,v 1.1 2013/3/18 09:38:16 pacho Exp $
...
TUXONICE_SNAPSHOT="2013-02-24"
TUXONICE_PV="$(replace_version_separator 2 '-')"
TUXONICE_PV="${TUXONICE_PV%%-*}".0
